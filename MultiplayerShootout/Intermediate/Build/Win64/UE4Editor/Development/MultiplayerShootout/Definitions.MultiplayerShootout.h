...
#define ORIGINAL_FILE_NAME "UE4Editor-MultiplayerShootout.dll"
#define UE_IS_ENGINE_MODULE 0
#define UE_BUILD_DEVELOPMENT_WITH_DEBUGGAME 0
#define UE_PROJECT_NAME MultiplayerShootout
#define DEPRECATED_FORGAME DEPRECATED
#define MULTIPLAYERSHOOTOUT_API DLLEXPORT
